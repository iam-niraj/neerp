...
LeadServiceResponse getServicesByLeadResponse(String str) =>
    LeadServiceResponse.fromJson(json.decode(str));

class LeadServiceResponse {
  int? success;
  List<Result>? result;

  LeadServiceResponse({this.success, this.result});

  LeadServiceResponse.fromJson(Map<String, dynamic> json) {

...
CompletedActivitiesResponseList completedActivitiesResponseJson(String str) =>
    CompletedActivitiesResponseList.fromJson(json.decode(str));

class CompletedActivitiesResponseList {
  int? success;
  List<Result>? result;

  CompletedActivitiesResponseList({this.success, this.result});

  CompletedActivitiesResponseList.fromJson(Map<String, dynamic> json) {

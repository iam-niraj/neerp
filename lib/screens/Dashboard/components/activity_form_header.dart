...
class BuildForm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          FilterCompletedActivitiesCubit(context.read<APIService>()),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: SingleChildScrollView(
        ...
        child: BlocListener<FilterCompletedActivitiesCubit,
            FilterCompletedActivitiesState>(
...
class _SubmitButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<FilterCompletedActivitiesCubit,
        FilterCompletedActivitiesState>(
      builder: (context, state) {
        return CustomFormButton(
          ...
          onPressed: () {
            context
                .read<FilterCompletedActivitiesCubit>()
                .filterAndFetchAllCompletedActivities();
          },
        );
      },
    );
